...
<div class="main">
  <div class="content">
    <div class="container_12">
      ...
      <div class="grid_12">
        <h3>Register</h3>
        <form  id="form" action="email_verification.php" method="post">
          ...
          <fieldset>            
			...
			<input type="submit" value="Submit" style="width:250px; margin-bottom:30px; text-align:center;">
  ...
  <div class="bottom_block">
    <div class="container_12">
      ...
      <h4>Contact Us:</h4>
        TEL: +8250946026<br>
        <a href="#">subhadipmaity43@gmail.com</a> </div>
      <div class="clear"></div>
    </div>
  </div>
</div>
