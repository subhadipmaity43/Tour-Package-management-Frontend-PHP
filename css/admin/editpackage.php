                    ...
                    if(isset($_POST['name']))
                    {
                            ...
                            if( $_FILES['photo']['name']!="")
                            {
                             ...
                             $pname=  str_replace(" ","_",$name).rand(1,1000).".".$ex; 
                              ...
                              $sql = "update package set name='$name',price='$price',description='$description',photo='$pname' where id='$eidtid' ";
  
                              mysqli_query($con,$sql);
                            }
                            else
                            {
                              $sql = "update package set name='$name',price='$price',description='$description'  where id='$eidtid' ";
